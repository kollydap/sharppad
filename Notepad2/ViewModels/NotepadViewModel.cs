...
namespace SharpPad.ViewModels
{
    public class NotepadViewModel : BaseViewModel
    {
        ...
        public bool IsNotepadDocumentsNull()
        {
        ...
        public void SaveNotepad(TextDocumentViewModel fivm, bool forceCreateFileAnyway = false)
        {
            try
            {
                ...
                else if (fivm.Document.FilePath.IsFile())
                {
        ...
        public void SaveSelectedNotepadAs()
        {
            try
            {
                if (!IsNotepadDocumentsNull() && NotepadAvaliable)
                    SaveNotepadAs(Notepad);
            }
            catch (Exception e)
            {
        ...
        private void ShowHideFindView(bool show)
        {
            if (show)
            {
                ...
                GlobalPreferences.IS_FIND_VISIBLE = true;
                View.FocusFindInput();
            }
            ...
            else
            {
                ...
                GlobalPreferences.IS_FIND_VISIBLE = false;
            }
        }
